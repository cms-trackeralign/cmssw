...
x_arrow = {
    ...
    'y1': TkMap_GEO['pixel']['FPIX-']['-2']['y_off'] + (PIX_D_W + 0.)/2.,
...
y_arrow = {
    ...
    'y2': TkMap_GEO['pixel']['FPIX-']['-2']['y_off'] + (PIX_D_W + 0.)/2.,
...
phi_arrow = {
    'label': '#phi',
    'alignment': 33,
    'x1': TkMap_GEO['pixel']['BPIX']['L1']['x_off'] + PIX_L_W,
    'y1': TkMap_GEO['pixel']['BPIX']['L1']['y_off'] - M_Y/8.,
    'x2': TkMap_GEO['pixel']['BPIX']['L1']['x_off'] ,
    'y2': TkMap_GEO['pixel']['BPIX']['L1']['y_off'] - M_Y/8.,
    #'label_pos': [x_arrow['x2'] + M_X, x_arrow['y2']]
}
